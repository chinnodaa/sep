...
const clubDetails = {
  box1: {
    name: "Automotive Engineering Club",
    description: "The Automotive Engineering Club caters to students interested in automotive design, manufacturing, and performance optimization. Members work on projects related to vehicle design, engine tuning, aerodynamics, and automotive systems, gaining practical skills relevant to the automotive industry!",
  },
//   box2: {
